...
: ${AMENT_CURRENT_PREFIX:="/mnt/data/xgs/code/end/install/end"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/end/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/end/environment/path.sh"
